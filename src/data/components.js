...
export const COMPONENT_DEFS = [
...

  {
    ...
    ampRatingSlot: { x: 0, y: 4, fontSize: 5.5, fill: '#7a3800', fontWeight: 'bold' },
    specs: {
      ampOptions:    ['6A','10A','16A','20A','25A','32A','40A','50A','63A'],
      poles:         '1P',
      curveType:     'C',
      Icu:           '4.5 kA',
      Ics:           '100% Icu',
      ...
      frequency:     '50/60 Hz',
      ipRating:      'IP20',
      dimensions:    '85 × 18 × 66 mm',
      weight:        '120 g',
      catalogNumber: 'EZ9F34016',
...

  {
    ...
    category: 'Schneider',
    viewBox: '-36 -42 76 88',
    ampRatingSlot: { x: 0, y: 4, fontSize: 6, fill: '#7a3800', fontWeight: 'bold' },
    specs: {
      ampOptions:    ['6A','10A','16A','20A','25A','32A','40A','50A','63A'],
      poles:         '3P',
      curveType:     'C',
      ...
      frequency:     '50/60 Hz',
      ipRating:      'IP20',
      dimensions:    '85 × 54 × 73 mm',
      weight:        '390 g',
      catalogNumber: 'A9F74316',
      standard:      'IEC/EN 60898-1',
    },
    ports: [
  ...
  // ── Schneider iC60N 1P (higher breaking capacity variant) ──
  {
    id: 'sch_mcb1_ic60n',
    name: 'MCB 1P – iC60N',
    category: 'Schneider',
    ...
    specs: {
      ...
      frequency:     '50/60 Hz',
      ipRating:      'IP20',
      dimensions:    '85 × 18 × 73 mm',
      weight:        '135 g',
      catalogNumber: 'A9F74116',
      standard:      'IEC/EN 60898-1',
    },
    symbol: [
      { type: 'rect', x: -13, y: -31, width: 26, height: 70, rx: 5, fill: '#00000028', stroke: 'none', filter: 'url(#fShadow)' },
      ...
      { type: 'text', x: -2, y: 11,   text: 'O', fontSize: 8, fill: '#7a3800', fontWeight: 'bold' },
      { type: 'rect', x: -12, y: 18,  width: 22, height: 7,  rx: 1.5, fill: '#fff', stroke: '#ccc', strokeWidth: 0.5 },
      { type: 'text', x: -1, y: 21.5, text: 'iC60N  1P', fontSize: 5, fill: '#009530', fontWeight: 'bold' },
    ],
  },

  // helper macro for 3D screws (reused across brands)
  // ── Schneider RCCB ──
  { id:'sch_rccb', name:'RCCB – iID', category:'Schneider',
    viewBox:'-32 -48 64 96', ports:[{x:-12,y:-48},{x:12,y:-48},{x:-12,y:48},{x:12,y:48}],
    specs: {
      ampOptions:         ['25A','40A','63A','80A','100A'],
      sensitivityOptions: ['30mA','300mA'],
      poles:              '2P',
      voltage:            '230V AC',
      frequency:          '50/60 Hz',
      ipRating:           'IP20',
      dimensions:         '85 × 36 × 70 mm',
      weight:             '210 g',
      catalogNumber:      'A9R44225',
      standard:           'IEC/EN 61008-1',
    },
    symbol:[
      {type:'rect',x:-30,y:-42,width:60,height:84,rx:5,fill:'#f5f5f5',stroke:'#999',strokeWidth:1},
      {type:'rect',x:-30,y:-42,width:3,height:84,rx:2,fill:'#fff',stroke:'none',opacity:0.6},
      {type:'rect',x:-30,y:-42,width:60,height:3,rx:2,fill:'#fff',stroke:'none',opacity:0.6},
      {type:'rect',x:27,y:-36,width:2,height:72,rx:1,fill:'#888',stroke:'none',opacity:0.4},
      {type:'line',x1:0,y1:-36,x2:0,y2:36,stroke:'#ccc',strokeWidth:1},
      // caps
      {type:'rect',x:-30,y:-42,width:60,height:16,rx:5,fill:'#e0e0e0',stroke:'#aaa',strokeWidth:0.8},
      {type:'rect',x:-29,y:-42,width:58,height:7,rx:4,fill:'#fff',stroke:'none',opacity:0.5},
      {type:'rect',x:-30,y:26,width:60,height:16,rx:5,fill:'#e0e0e0',stroke:'#aaa',strokeWidth:0.8},
      // wire stubs
      {type:'line',x1:-12,y1:-48,x2:-12,y2:-42,stroke:'#777',strokeWidth:2},
      {type:'line',x1:12,y1:-48,x2:12,y2:-42,stroke:'#777',strokeWidth:2},
      {type:'line',x1:-12,y1:42,x2:-12,y2:48,stroke:'#777',strokeWidth:2},
      {type:'line',x1:12,y1:42,x2:12,y2:48,stroke:'#777',strokeWidth:2},
      // screws
      {type:'circle',cx:-12,cy:-33,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:-12,cy:-33,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-14.8,y1:-33,x2:-9.2,y2:-33,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:12,cy:-33,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:12,cy:-33,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:9.2,y1:-33,x2:14.8,y2:-33,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:-12,cy:33,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:-12,cy:33,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-14.8,y1:33,x2:-9.2,y2:33,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:12,cy:33,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:12,cy:33,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:9.2,y1:33,x2:14.8,y2:33,stroke:'#666',strokeWidth:1},
      // green band
      {type:'rect',x:-30,y:-24,width:60,height:9,fill:'url(#gGreenSch)',stroke:'none'},
      {type:'rect',x:-30,y:-24,width:60,height:4,fill:'#fff',stroke:'none',opacity:0.15},
      {type:'text',x:0,y:-19,text:'Schneider',fontSize:4.5,fill:'#fff',fontWeight:'bold'},
      // label strip top
      {type:'rect',x:-26,y:-42,width:52,height:7,rx:1.5,fill:'#fff',stroke:'#ccc',strokeWidth:0.5},
      {type:'text',x:0,y:-38,text:'iID  RCCB  2P',fontSize:5,fill:'#009530',fontWeight:'bold'},
      // orange toggle
      {type:'rect',x:-25,y:-13,width:50,height:32,rx:4,fill:'url(#gOrange)',stroke:'#c47a10',strokeWidth:1},
      {type:'rect',x:-23,y:-12,width:46,height:12,rx:3,fill:'#fff',stroke:'none',opacity:0.3},
      {type:'text',x:0,y:-6,text:'I',fontSize:9,fill:'#7a3800',fontWeight:'bold'},
      {type:'text',x:0,y:9,text:'O',fontSize:8,fill:'#7a3800',fontWeight:'bold'},
      // TEST button
      {type:'rect',x:-12,y:20,width:24,height:8,rx:4,fill:'#ffe082',stroke:'#f9a825',strokeWidth:1},
      {type:'text',x:0,y:24,text:'TEST',fontSize:4.5,fill:'#5d4037'},
    ]},

  // ── Schneider Contactor ──
  { id:'sch_contactor', name:'Contactor – LC1D', category:'Schneider',
    viewBox:'-36 -52 72 104', ports:[{x:-18,y:-52},{x:0,y:-52},{x:18,y:-52},{x:-18,y:52},{x:0,y:52},{x:18,y:52}],
    symbol:[
      {type:'rect',x:-34,y:-46,width:68,height:92,rx:5,fill:'#f5f5f5',stroke:'#999',strokeWidth:1},
      {type:'rect',x:-34,y:-46,width:3,height:92,rx:2,fill:'#fff',stroke:'none',opacity:0.6},
      {type:'rect',x:-34,y:-46,width:68,height:3,rx:2,fill:'#fff',stroke:'none',opacity:0.6},
      {type:'rect',x:31,y:-40,width:2,height:80,rx:1,fill:'#888',stroke:'none',opacity:0.4},
      // pole dividers
      {type:'line',x1:-12,y1:-28,x2:-12,y2:28,stroke:'#ccc',strokeWidth:1},
      {type:'line',x1:12,y1:-28,x2:12,y2:28,stroke:'#ccc',strokeWidth:1},
      // caps
      {type:'rect',x:-34,y:-46,width:68,height:18,rx:5,fill:'#e0e0e0',stroke:'#aaa',strokeWidth:0.8},
      {type:'rect',x:-33,y:-46,width:66,height:8,rx:4,fill:'#fff',stroke:'none',opacity:0.5},
      {type:'rect',x:-34,y:28,width:68,height:18,rx:5,fill:'#e0e0e0',stroke:'#aaa',strokeWidth:0.8},
      // wire stubs
      {type:'line',x1:-18,y1:-52,x2:-18,y2:-46,stroke:'#777',strokeWidth:2},{type:'line',x1:0,y1:-52,x2:0,y2:-46,stroke:'#777',strokeWidth:2},{type:'line',x1:18,y1:-52,x2:18,y2:-46,stroke:'#777',strokeWidth:2},
      {type:'line',x1:-18,y1:46,x2:-18,y2:52,stroke:'#777',strokeWidth:2},{type:'line',x1:0,y1:46,x2:0,y2:52,stroke:'#777',strokeWidth:2},{type:'line',x1:18,y1:46,x2:18,y2:52,stroke:'#777',strokeWidth:2},
      // 3D screws
      {type:'circle',cx:-18,cy:-36,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:-18,cy:-36,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-20.8,y1:-36,x2:-15.2,y2:-36,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:0,cy:-36,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:0,cy:-36,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-2.8,y1:-36,x2:2.8,y2:-36,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:18,cy:-36,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:18,cy:-36,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:15.2,y1:-36,x2:20.8,y2:-36,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:-18,cy:38,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:-18,cy:38,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-20.8,y1:38,x2:-15.2,y2:38,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:0,cy:38,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:0,cy:38,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-2.8,y1:38,x2:2.8,y2:38,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:18,cy:38,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:18,cy:38,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:15.2,y1:38,x2:20.8,y2:38,stroke:'#666',strokeWidth:1},
      // green band
      {type:'rect',x:-34,y:-26,width:68,height:9,fill:'url(#gGreenSch)',stroke:'none'},
      {type:'rect',x:-34,y:-26,width:68,height:4,fill:'#fff',stroke:'none',opacity:0.15},
      {type:'text',x:0,y:-21,text:'Schneider Electric',fontSize:4.5,fill:'#fff',fontWeight:'bold'},
      // coil housing
      {type:'rect',x:-30,y:-15,width:60,height:40,rx:4,fill:'#e0e0e0',stroke:'#bbb',strokeWidth:1},
      {type:'rect',x:-28,y:-13,width:56,height:10,rx:3,fill:'#fff',stroke:'none',opacity:0.4},
      {type:'path',d:'M-24,-5 C-20,-13 -14,-13 -10,-5 C-6,3 0,3 4,-5 C8,-13 14,-13 18,-5',fill:'none',stroke:'url(#gGreenSch)',strokeWidth:2},
      {type:'path',d:'M-24,8 C-20,0 -14,0 -10,8 C-6,16 0,16 4,8 C8,0 14,0 18,8',fill:'none',stroke:'url(#gGreenSch)',strokeWidth:2},
      {type:'text',x:0,y:22,text:'LC1D',fontSize:8,fill:'#009530',fontWeight:'bold'},
    ]},
  ...
  { id:'abb_mcb1', name:'MCB 1P – S201', category:'ABB',
    viewBox:'-16 -42 32 86', ports:[{x:0,y:-42},{x:0,y:42}],
    ampRatingSlot: { x: 0, y: 4, fontSize: 5.5, fill: '#fff', fontWeight: 'bold' },
    specs: {
      ampOptions:    ['6A','10A','16A','20A','25A','32A','40A','50A','63A'],
      poles:         '1P',
      curveType:     'C',
      ...
      frequency:     '50/60 Hz',
      ipRating:      'IP20',
      dimensions:    '88 × 17.5 × 66 mm',
      weight:        '110 g',
      catalogNumber: '2CDS251001R0164',
      standard:      'IEC/EN 60898-1',
    },
    symbol:[
      {type:'rect',x:-14,y:-33,width:26,height:70,rx:5,fill:'#f5f5f5',stroke:'#999',strokeWidth:1},
      {type:'rect',x:-14,y:-33,width:3,height:70,rx:2,fill:'#fff',stroke:'none',opacity:0.6},
      {type:'rect',x:-14,y:-33,width:26,height:3,rx:2,fill:'#fff',stroke:'none',opacity:0.6},
      {type:'rect',x:9,y:-28,width:2,height:58,rx:1,fill:'#888',stroke:'none',opacity:0.4},
      {type:'rect',x:-14,y:-33,width:26,height:16,rx:5,fill:'#e0e0e0',stroke:'#aaa',strokeWidth:0.8},
      {type:'rect',x:-13,y:-33,width:24,height:7,rx:4,fill:'#fff',stroke:'none',opacity:0.5},
      {type:'rect',x:-14,y:20,width:26,height:16,rx:5,fill:'#e0e0e0',stroke:'#aaa',strokeWidth:0.8},
      {type:'line',x1:0,y1:-42,x2:0,y2:-33,stroke:'#777',strokeWidth:2},{type:'line',x1:0,y1:36,x2:0,y2:42,stroke:'#777',strokeWidth:2},
      {type:'circle',cx:0,cy:-26,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:0,cy:-26,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-2.8,y1:-26,x2:2.8,y2:-26,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:0,cy:28,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:0,cy:28,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-2.8,y1:28,x2:2.8,y2:28,stroke:'#666',strokeWidth:1},
      {type:'rect',x:-14,y:-18,width:26,height:9,fill:'url(#gRedABB)',stroke:'none'},
      {type:'rect',x:-14,y:-18,width:26,height:4,fill:'#fff',stroke:'none',opacity:0.2},
      {type:'text',x:-1,y:-13,text:'ABB',fontSize:5.5,fill:'#fff',fontWeight:'bold'},
      {type:'rect',x:-12,y:-8,width:20,height:25,rx:4,fill:'#424242',stroke:'#111',strokeWidth:1},
      {type:'rect',x:-10,y:-7,width:16,height:10,rx:3,fill:'#fff',stroke:'none',opacity:0.15},
      {type:'text',x:-2,y:-1,text:'I',fontSize:9,fill:'#fff',fontWeight:'bold'},
      {type:'text',x:-2,y:11,text:'O',fontSize:8,fill:'#aaa',fontWeight:'bold'},
      {type:'rect',x:-12,y:18,width:22,height:7,rx:1.5,fill:'url(#gRedABB)',stroke:'none'},
      {type:'text',x:-1,y:21.5,text:'S201',fontSize:5,fill:'#fff',fontWeight:'bold'},
    ]},

  { id:'abb_mcb3', name:'MCB 3P – S203', category:'ABB',
    viewBox:'-36 -42 76 88', ports:[{x:-20,y:-42},{x:0,y:-42},{x:20,y:-42},{x:-20,y:42},{x:0,y:42},{x:20,y:42}],
    ampRatingSlot: { x: 0, y: 4, fontSize: 6, fill: '#fff', fontWeight: 'bold' },
    specs: {
      ampOptions:    ['6A','10A','16A','20A','25A','32A','40A','50A','63A'],
      poles:         '3P',
      curveType:     'C',
      ...
      frequency:     '50/60 Hz',
      ipRating:      'IP20',
      dimensions:    '88 × 52.5 × 66 mm',
      weight:        '330 g',
      catalogNumber: '2CDS253001R0164',
      standard:      'IEC/EN 60898-1',
    },
    symbol:[
      {type:'rect',x:-34,y:-34,width:68,height:70,rx:5,fill:'#f5f5f5',stroke:'#999',strokeWidth:1},
      {type:'rect',x:-34,y:-34,width:3,height:70,rx:2,fill:'#fff',stroke:'none',opacity:0.6},
      {type:'rect',x:-34,y:-34,width:68,height:3,rx:2,fill:'#fff',stroke:'none',opacity:0.6},
      {type:'rect',x:31,y:-28,width:2,height:58,rx:1,fill:'#888',stroke:'none',opacity:0.4},
      {type:'line',x1:-11,y1:-18,x2:-11,y2:20,stroke:'#bbb',strokeWidth:1},{type:'line',x1:11,y1:-18,x2:11,y2:20,stroke:'#bbb',strokeWidth:1},
      {type:'rect',x:-34,y:-34,width:68,height:16,rx:5,fill:'#e0e0e0',stroke:'#aaa',strokeWidth:0.8},
      {type:'rect',x:-33,y:-34,width:66,height:7,rx:4,fill:'#fff',stroke:'none',opacity:0.5},
      {type:'rect',x:-34,y:20,width:68,height:16,rx:5,fill:'#e0e0e0',stroke:'#aaa',strokeWidth:0.8},
      {type:'line',x1:-20,y1:-42,x2:-20,y2:-34,stroke:'#777',strokeWidth:2},{type:'line',x1:0,y1:-42,x2:0,y2:-34,stroke:'#777',strokeWidth:2},{type:'line',x1:20,y1:-42,x2:20,y2:-34,stroke:'#777',strokeWidth:2},
      {type:'line',x1:-20,y1:36,x2:-20,y2:42,stroke:'#777',strokeWidth:2},{type:'line',x1:0,y1:36,x2:0,y2:42,stroke:'#777',strokeWidth:2},{type:'line',x1:20,y1:36,x2:20,y2:42,stroke:'#777',strokeWidth:2},
      {type:'circle',cx:-20,cy:-26,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:-20,cy:-26,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-22.8,y1:-26,x2:-17.2,y2:-26,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:0,cy:-26,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:0,cy:-26,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-2.8,y1:-26,x2:2.8,y2:-26,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:20,cy:-26,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:20,cy:-26,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:17.2,y1:-26,x2:22.8,y2:-26,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:-20,cy:28,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:-20,cy:28,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-22.8,y1:28,x2:-17.2,y2:28,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:0,cy:28,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:0,cy:28,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-2.8,y1:28,x2:2.8,y2:28,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:20,cy:28,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:20,cy:28,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:17.2,y1:28,x2:22.8,y2:28,stroke:'#666',strokeWidth:1},
      {type:'rect',x:-34,y:-18,width:68,height:9,fill:'url(#gRedABB)',stroke:'none'},
      {type:'rect',x:-34,y:-18,width:68,height:4,fill:'#fff',stroke:'none',opacity:0.2},
      {type:'text',x:0,y:-13,text:'ABB',fontSize:6,fill:'#fff',fontWeight:'bold'},
      {type:'rect',x:-31,y:-8,width:62,height:26,rx:4,fill:'#424242',stroke:'#111',strokeWidth:1},
      {type:'rect',x:-29,y:-7,width:58,height:11,rx:3,fill:'#fff',stroke:'none',opacity:0.15},
      {type:'text',x:0,y:-2,text:'I',fontSize:9,fill:'#fff',fontWeight:'bold'},
      {type:'text',x:0,y:11,text:'O',fontSize:8,fill:'#aaa'},
      {type:'rect',x:-30,y:18,width:60,height:8,rx:1.5,fill:'url(#gRedABB)',stroke:'none'},
      {type:'text',x:0,y:22,text:'S203  3P',fontSize:5.5,fill:'#fff',fontWeight:'bold'},
    ]},

  { id:'abb_rccb', name:'RCCB – F201', category:'ABB',
    viewBox:'-32 -48 64 96', ports:[{x:-12,y:-48},{x:12,y:-48},{x:-12,y:48},{x:12,y:48}],
    specs: {
      ampOptions:         ['25A','40A','63A'],
      sensitivityOptions: ['30mA','300mA'],
      poles:              '2P',
      voltage:            '230V AC',
      frequency:          '50/60 Hz',
      ipRating:           'IP40',
      dimensions:         '88 × 35 × 66 mm',
      weight:             '195 g',
      catalogNumber:      '2CSF201001R1250',
      standard:           'IEC/EN 61008-1',
    },
    symbol:[
      {type:'rect',x:-30,y:-42,width:60,height:84,rx:5,fill:'#f5f5f5',stroke:'#999',strokeWidth:1},
      ...
      {type:'rect',x:-29,y:-42,width:58,height:7,rx:4,fill:'#fff',stroke:'none',opacity:0.5},
      {type:'rect',x:-30,y:26,width:60,height:16,rx:5,fill:'#e0e0e0',stroke:'#aaa',strokeWidth:0.8},
      {type:'line',x1:-12,y1:-48,x2:-12,y2:-42,stroke:'#777',strokeWidth:2},{type:'line',x1:12,y1:-48,x2:12,y2:-42,stroke:'#777',strokeWidth:2},
      {type:'line',x1:-12,y1:42,x2:-12,y2:48,stroke:'#777',strokeWidth:2},{type:'line',x1:12,y1:42,x2:12,y2:48,stroke:'#777',strokeWidth:2},
      {type:'circle',cx:-12,cy:-33,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:-12,cy:-33,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-14.8,y1:-33,x2:-9.2,y2:-33,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:12,cy:-33,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:12,cy:-33,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:9.2,y1:-33,x2:14.8,y2:-33,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:-12,cy:33,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:-12,cy:33,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-14.8,y1:33,x2:-9.2,y2:33,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:12,cy:33,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:12,cy:33,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:9.2,y1:33,x2:14.8,y2:33,stroke:'#666',strokeWidth:1},
      {type:'rect',x:-30,y:-24,width:60,height:9,fill:'url(#gRedABB)',stroke:'none'},
      {type:'rect',x:-30,y:-24,width:60,height:4,fill:'#fff',stroke:'none',opacity:0.2},
      {type:'rect',x:-26,y:-42,width:52,height:7,rx:1.5,fill:'url(#gRedABB)',stroke:'none'},
      {type:'text',x:0,y:-38,text:'F200  RCCB  2P',fontSize:5,fill:'#fff',fontWeight:'bold'},
      {type:'text',x:0,y:-19,text:'ABB',fontSize:6,fill:'#fff',fontWeight:'bold'},
      {type:'rect',x:-24,y:-13,width:48,height:32,rx:4,fill:'#424242',stroke:'#111',strokeWidth:1},
      {type:'rect',x:-22,y:-12,width:44,height:12,rx:3,fill:'#fff',stroke:'none',opacity:0.15},
      {type:'text',x:0,y:-6,text:'I',fontSize:9,fill:'#fff',fontWeight:'bold'},
      {type:'text',x:0,y:8,text:'O',fontSize:8,fill:'#aaa'},
      {type:'rect',x:-12,y:20,width:24,height:8,rx:4,fill:'#ffe082',stroke:'#f9a825',strokeWidth:1},
      {type:'text',x:0,y:24,text:'TEST',fontSize:4.5,fill:'#5d4037'},
    ]},  // end abb_rccb

  { id:'abb_contactor', name:'Contactor – AF series', category:'ABB',
    viewBox:'-36 -52 72 104', ports:[{x:-18,y:-52},{x:0,y:-52},{x:18,y:-52},{x:-18,y:52},{x:0,y:52},{x:18,y:52}],
    symbol:[
      {type:'rect',x:-34,y:-46,width:68,height:92,rx:5,fill:'#f5f5f5',stroke:'#999',strokeWidth:1},
      {type:'rect',x:-34,y:-46,width:3,height:92,rx:2,fill:'#fff',stroke:'none',opacity:0.6},
      {type:'rect',x:-34,y:-46,width:68,height:3,rx:2,fill:'#fff',stroke:'none',opacity:0.6},
      {type:'line',x1:-12,y1:-28,x2:-12,y2:28,stroke:'#ccc',strokeWidth:1},{type:'line',x1:12,y1:-28,x2:12,y2:28,stroke:'#ccc',strokeWidth:1},
      {type:'rect',x:-34,y:-46,width:68,height:18,rx:5,fill:'#e0e0e0',stroke:'#aaa',strokeWidth:0.8},
      {type:'rect',x:-33,y:-46,width:66,height:8,rx:4,fill:'#fff',stroke:'none',opacity:0.5},
      {type:'rect',x:-34,y:28,width:68,height:18,rx:5,fill:'#e0e0e0',stroke:'#aaa',strokeWidth:0.8},
      {type:'line',x1:-18,y1:-52,x2:-18,y2:-46,stroke:'#777',strokeWidth:2},{type:'line',x1:0,y1:-52,x2:0,y2:-46,stroke:'#777',strokeWidth:2},{type:'line',x1:18,y1:-52,x2:18,y2:-46,stroke:'#777',strokeWidth:2},
      ...
      {type:'circle',cx:0,cy:38,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:0,cy:38,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-2.8,y1:38,x2:2.8,y2:38,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:18,cy:38,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:18,cy:38,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:15.2,y1:38,x2:20.8,y2:38,stroke:'#666',strokeWidth:1},
      {type:'rect',x:-34,y:-26,width:68,height:9,fill:'url(#gRedABB)',stroke:'none'},
      {type:'rect',x:-34,y:-26,width:68,height:4,fill:'#fff',stroke:'none',opacity:0.2},
      {type:'text',x:0,y:-21,text:'ABB',fontSize:6,fill:'#fff',fontWeight:'bold'},
      {type:'rect',x:-30,y:-15,width:60,height:40,rx:4,fill:'#424242',stroke:'#222',strokeWidth:1},
      {type:'rect',x:-28,y:-13,width:56,height:12,rx:3,fill:'#fff',stroke:'none',opacity:0.12},
      {type:'path',d:'M-24,-5 C-20,-13 -14,-13 -10,-5 C-6,3 0,3 4,-5 C8,-13 14,-13 18,-5',fill:'none',stroke:'#e53935',strokeWidth:2},
      {type:'path',d:'M-24,8 C-20,0 -14,0 -10,8 C-6,16 0,16 4,8 C8,0 14,0 18,8',fill:'none',stroke:'#e53935',strokeWidth:2},
      {type:'text',x:0,y:22,text:'AF series',fontSize:7,fill:'#fff',fontWeight:'bold'},
    ]},
  ...
  { id:'sie_mcb1', name:'MCB 1P – 5SL4', category:'Siemens',
    viewBox:'-16 -42 32 86', ports:[{x:0,y:-42},{x:0,y:42}],
    ampRatingSlot: { x: 0, y: 4, fontSize: 5.5, fill: '#00bcd4', fontWeight: 'bold' },
    specs: {
      ampOptions:    ['6A','10A','16A','20A','25A','32A','40A','50A','63A'],
      poles:         '1P',
      curveType:     'C',
      ...
      frequency:     '50/60 Hz',
      ipRating:      'IP20',
      dimensions:    '87 × 18 × 66 mm',
      weight:        '115 g',
      catalogNumber: '5SL4116-7',
      standard:      'IEC/EN 60898-1',
    },
    symbol:[
      {type:'rect',x:-14,y:-33,width:26,height:70,rx:5,fill:'#f5f5f5',stroke:'#999',strokeWidth:1},
      ...
      {type:'circle',cx:0,cy:-26,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:0,cy:-26,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-2.8,y1:-26,x2:2.8,y2:-26,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:0,cy:28,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:0,cy:28,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-2.8,y1:28,x2:2.8,y2:28,stroke:'#666',strokeWidth:1},
      {type:'rect',x:-14,y:-18,width:26,height:9,fill:'url(#gTealSie)',stroke:'none'},
      {type:'rect',x:-14,y:-18,width:26,height:4,fill:'#fff',stroke:'none',opacity:0.2},
      {type:'text',x:-1,y:-13,text:'SIEMENS',fontSize:3.5,fill:'#fff',fontWeight:'bold'},
      {type:'rect',x:-12,y:-8,width:20,height:25,rx:4,fill:'#333',stroke:'#111',strokeWidth:1},
      {type:'rect',x:-10,y:-7,width:16,height:10,rx:3,fill:'#fff',stroke:'none',opacity:0.12},
      {type:'text',x:-2,y:-1,text:'I',fontSize:9,fill:'#00bcd4',fontWeight:'bold'},
      {type:'text',x:-2,y:11,text:'O',fontSize:8,fill:'#777'},
      {type:'rect',x:-12,y:18,width:22,height:7,rx:1.5,fill:'url(#gTealSie)',stroke:'none'},
      {type:'text',x:-1,y:21.5,text:'5SL4',fontSize:5.5,fill:'#fff',fontWeight:'bold'},
    ]},

  { id:'sie_mcb3', name:'MCB 3P – 5SL6', category:'Siemens',
    viewBox:'-36 -42 76 88', ports:[{x:-20,y:-42},{x:0,y:-42},{x:20,y:-42},{x:-20,y:42},{x:0,y:42},{x:20,y:42}],
    ampRatingSlot: { x: 0, y: 4, fontSize: 6, fill: '#00bcd4', fontWeight: 'bold' },
    specs: {
      ampOptions:    ['6A','10A','16A','20A','25A','32A','40A','50A','63A'],
      poles:         '3P',
      curveType:     'C',
      ...
      frequency:     '50/60 Hz',
      ipRating:      'IP20',
      dimensions:    '87 × 54 × 66 mm',
      weight:        '345 g',
      catalogNumber: '5SL6316-7',
      standard:      'IEC/EN 60898-1',
    },
    symbol:[
      {type:'rect',x:-34,y:-34,width:68,height:70,rx:5,fill:'#f5f5f5',stroke:'#999',strokeWidth:1},
      ...
      {type:'circle',cx:0,cy:28,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:0,cy:28,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-2.8,y1:28,x2:2.8,y2:28,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:20,cy:28,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:20,cy:28,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:17.2,y1:28,x2:22.8,y2:28,stroke:'#666',strokeWidth:1},
      {type:'rect',x:-34,y:-18,width:68,height:9,fill:'url(#gTealSie)',stroke:'none'},
      {type:'rect',x:-34,y:-18,width:68,height:4,fill:'#fff',stroke:'none',opacity:0.2},
      {type:'text',x:0,y:-13,text:'SIEMENS',fontSize:5,fill:'#fff',fontWeight:'bold'},
      {type:'rect',x:-31,y:-8,width:62,height:26,rx:4,fill:'#333',stroke:'#111',strokeWidth:1},
      {type:'rect',x:-29,y:-7,width:58,height:11,rx:3,fill:'#fff',stroke:'none',opacity:0.12},
      {type:'text',x:0,y:-2,text:'I',fontSize:9,fill:'#00bcd4',fontWeight:'bold'},
      {type:'text',x:0,y:11,text:'O',fontSize:8,fill:'#777'},
      {type:'rect',x:-30,y:18,width:60,height:8,rx:1.5,fill:'url(#gTealSie)',stroke:'none'},
      {type:'text',x:0,y:22,text:'5SL6  3P',fontSize:5.5,fill:'#fff',fontWeight:'bold'},
    ]},

  { id:'sie_rccb', name:'RCCB – 5SV', category:'Siemens',
    viewBox:'-32 -48 64 96', ports:[{x:-12,y:-48},{x:12,y:-48},{x:-12,y:48},{x:12,y:48}],
    specs: {
      ampOptions:         ['25A','40A','63A'],
      sensitivityOptions: ['30mA','300mA'],
      ...
      frequency:          '50/60 Hz',
      ipRating:           'IP20',
      dimensions:         '87 × 36 × 66 mm',
      weight:             '200 g',
      catalogNumber:      '5SV3316-6',
      standard:           'IEC/EN 61008-1',
    },
    symbol:[
      {type:'rect',x:-30,y:-42,width:60,height:84,rx:5,fill:'#f5f5f5',stroke:'#999',strokeWidth:1},
      ...
      {type:'circle',cx:-12,cy:33,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:-12,cy:33,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:-14.8,y1:33,x2:-9.2,y2:33,stroke:'#666',strokeWidth:1},
      {type:'circle',cx:12,cy:33,r:5.5,fill:'#aaa',stroke:'none'},{type:'circle',cx:12,cy:33,r:5,fill:'url(#gScrew)',stroke:'#888',strokeWidth:0.8},{type:'line',x1:9.2,y1:33,x2:14.8,y2:33,stroke:'#666',strokeWidth:1},
      {type:'rect',x:-30,y:-24,width:60,height:9,fill:'url(#gTealSie)',stroke:'none'},
      {type:'rect',x:-30,y:-24,width:60,height:4,fill:'#fff',stroke:'none',opacity:0.2},
      {type:'rect',x:-26,y:-42,width:52,height:7,rx:1.5,fill:'url(#gTealSie)',stroke:'none'},
      {type:'text',x:0,y:-38,text:'5SV  RCCB  2P',fontSize:5,fill:'#fff',fontWeight:'bold'},
      {type:'text',x:0,y:-19,text:'SIEMENS',fontSize:5,fill:'#fff',fontWeight:'bold'},
      {type:'rect',x:-24,y:-13,width:48,height:32,rx:4,fill:'#333',stroke:'#111',strokeWidth:1},
      {type:'rect',x:-22,y:-12,width:44,height:12,rx:3,fill:'#fff',stroke:'none',opacity:0.12},
      {type:'text',x:0,y:-6,text:'I',fontSize:9,fill:'#00bcd4',fontWeight:'bold'},
      {type:'text',x:0,y:8,text:'O',fontSize:8,fill:'#777'},
      {type:'rect',x:-12,y:20,width:24,height:8,rx:4,fill:'#ffe082',stroke:'#f9a825',strokeWidth:1},
      {type:'text',x:0,y:24,text:'TEST',fontSize:4.5,fill:'#5d4037'},
    ]},

  // ══════════════════════════════════════════════════════
  // LEGRAND  — white body, lime #8bc34a
  // ══════════════════════════════════════════════════════

  { id:'leg_mcb1', name:'MCB 1P – DX³', category:'Legrand',
    viewBox:'-16 -42 32 86', ports:[{x:0,y:-42},{x:0,y:42}],
    ampRatingSlot: { x: 0, y: 4, fontSize: 5.5, fill: '#fff', fontWeight: 'bold' },
    specs: {
      ampOptions:    ['6A','10A','16A','20A','25A','32A','40A','50A','63A'],
      ...
      frequency:     '50/60 Hz',
      ipRating:      'IP20',
      dimensions:    '83 × 18 × 74 mm',
      weight:        '125 g',
      catalogNumber: '407523',
      standard:      'IEC/EN 60898-1',
    },
    symbol:[
      {type:'rect',x:-14,y:-33,width:26,height:70,rx:5,fill:'#fff',stroke:'#ccc',strokeWidth:1},
      {type:'rect',x:-14,y:-33,width:3,height:70,rx:2,fill:'#fff',stroke:'none',opacity:0.8},
      {type:'rect',x:-14,y:-33,width:26,height:3,rx:2,fill:'#fff',stroke:'none',opacity:0.8},
      {type:'rect',x:9,y:-28,width:2,height:58,rx:1,fill:'#bbb',stroke:'none',opacity:0.5},
      {type:'rect',x:-14,y:-33,width:26,height:16,rx:5,fill:'#e0e0e0',stroke:'#ccc',strokeWidth:0.8},
      {type:'rect',x:-13,y:-33,width:24,height:7,rx:4,fill:'#fff',stroke:'none',opacity:0.7},
      {type:'rect',x:-14,y:20,width:26,height:16,rx:5,fill:'#e0e0e0',stroke:'#ccc',strokeWidth:0.8},
      {type:'line',x1:0,y1:-42,x2:0,y2:-33,stroke:'#777',strokeWidth:2},{type:'line',x1:0,y1:36,x2:0,y2:42,stroke:'#777',strokeWidth:2},
      {type:'circle',cx:0,cy:-26,r:5.5,fill:'#bbb',stroke:'none'},{type:'circle',cx:0,cy:-26,r:5,fill:'url(#gScrew)',stroke:'#aaa',strokeWidth:0.8},{type:'line',x1:-2.8,y1:-26,x2:2.8,y2:-26,stroke:'#888',strokeWidth:1},
      {type:'circle',cx:0,cy:28,r:5.5,fill:'#bbb',stroke:'none'},{type:'circle',cx:0,cy:28,r:5,fill:'url(#gScrew)',stroke:'#aaa',strokeWidth:0.8},{type:'line',x1:-2.8,y1:28,x2:2.8,y2:28,stroke:'#888',strokeWidth:1},
      {type:'rect',x:-14,y:-18,width:26,height:9,fill:'#8bc34a',stroke:'none'},
      {type:'rect',x:-14,y:-18,width:26,height:4,fill:'#fff',stroke:'none',opacity:0.3},
      {type:'text',x:-1,y:-13,text:'legrand',fontSize:4,fill:'#fff',fontWeight:'bold'},
      {type:'rect',x:-12,y:-8,width:20,height:25,rx:4,fill:'#212121',stroke:'#000',strokeWidth:1},
      {type:'rect',x:-10,y:-7,width:16,height:10,rx:3,fill:'#8bc34a',stroke:'none',opacity:0.9},
      {type:'rect',x:-10,y:-7,width:16,height:4,rx:2,fill:'#fff',stroke:'none',opacity:0.3},
      {type:'text',x:-2,y:-1,text:'I',fontSize:9,fill:'#fff',fontWeight:'bold'},
      {type:'text',x:-2,y:11,text:'O',fontSize:8,fill:'#555'},
      {type:'rect',x:-12,y:18,width:22,height:7,rx:1.5,fill:'#212121',stroke:'none'},
      {type:'text',x:-1,y:21.5,text:'DX³',fontSize:5.5,fill:'#8bc34a',fontWeight:'bold'},
    ]},

  { id:'leg_mcb3', name:'MCB 3P – DX³', category:'Legrand',
    viewBox:'-36 -42 76 88', ports:[{x:-20,y:-42},{x:0,y:-42},{x:20,y:-42},{x:-20,y:42},{x:0,y:42},{x:20,y:42}],
    ampRatingSlot: { x: 0, y: 4, fontSize: 6, fill: '#fff', fontWeight: 'bold' },
    specs: {
      ampOptions:    ['6A','10A','16A','20A','25A','32A','40A','50A','63A'],
      ...
      frequency:     '50/60 Hz',
      ipRating:      'IP20',
      dimensions:    '83 × 54 × 74 mm',
      weight:        '375 g',
      catalogNumber: '406350',
      standard:      'IEC/EN 60898-1',
    },
    symbol:[
      {type:'rect',x:-34,y:-34,width:68,height:70,rx:5,fill:'#fff',stroke:'#ccc',strokeWidth:1},
      {type:'rect',x:-34,y:-34,width:3,height:70,rx:2,fill:'#fff',stroke:'none',opacity:0.8},
      {type:'rect',x:-34,y:-34,width:68,height:3,rx:2,fill:'#fff',stroke:'none',opacity:0.8},
      {type:'rect',x:31,y:-28,width:2,height:58,rx:1,fill:'#bbb',stroke:'none',opacity:0.5},
      {type:'line',x1:-11,y1:-18,x2:-11,y2:20,stroke:'#ddd',strokeWidth:1},{type:'line',x1:11,y1:-18,x2:11,y2:20,stroke:'#ddd',strokeWidth:1},
      {type:'rect',x:-34,y:-34,width:68,height:16,rx:5,fill:'#e0e0e0',stroke:'#ccc',strokeWidth:0.8},
      {type:'rect',x:-33,y:-34,width:66,height:7,rx:4,fill:'#fff',stroke:'none',opacity:0.7},
      {type:'rect',x:-34,y:20,width:68,height:16,rx:5,fill:'#e0e0e0',stroke:'#ccc',strokeWidth:0.8},
      {type:'line',x1:-20,y1:-42,x2:-20,y2:-34,stroke:'#777',strokeWidth:2},{type:'line',x1:0,y1:-42,x2:0,y2:-34,stroke:'#777',strokeWidth:2},{type:'line',x1:20,y1:-42,x2:20,y2:-34,stroke:'#777',strokeWidth:2},
      {type:'line',x1:-20,y1:36,x2:-20,y2:42,stroke:'#777',strokeWidth:2},{type:'line',x1:0,y1:36,x2:0,y2:42,stroke:'#777',strokeWidth:2},{type:'line',x1:20,y1:36,x2:20,y2:42,stroke:'#777',strokeWidth:2},
      {type:'circle',cx:-20,cy:-26,r:5.5,fill:'#bbb',stroke:'none'},{type:'circle',cx:-20,cy:-26,r:5,fill:'url(#gScrew)',stroke:'#aaa',strokeWidth:0.8},{type:'line',x1:-22.8,y1:-26,x2:-17.2,y2:-26,stroke:'#888',strokeWidth:1},
      {type:'circle',cx:0,cy:-26,r:5.5,fill:'#bbb',stroke:'none'},{type:'circle',cx:0,cy:-26,r:5,fill:'url(#gScrew)',stroke:'#aaa',strokeWidth:0.8},{type:'line',x1:-2.8,y1:-26,x2:2.8,y2:-26,stroke:'#888',strokeWidth:1},
      {type:'circle',cx:20,cy:-26,r:5.5,fill:'#bbb',stroke:'none'},{type:'circle',cx:20,cy:-26,r:5,fill:'url(#gScrew)',stroke:'#aaa',strokeWidth:0.8},{type:'line',x1:17.2,y1:-26,x2:22.8,y2:-26,stroke:'#888',strokeWidth:1},
      {type:'circle',cx:-20,cy:28,r:5.5,fill:'#bbb',stroke:'none'},{type:'circle',cx:-20,cy:28,r:5,fill:'url(#gScrew)',stroke:'#aaa',strokeWidth:0.8},{type:'line',x1:-22.8,y1:28,x2:-17.2,y2:28,stroke:'#888',strokeWidth:1},
      {type:'circle',cx:0,cy:28,r:5.5,fill:'#bbb',stroke:'none'},{type:'circle',cx:0,cy:28,r:5,fill:'url(#gScrew)',stroke:'#aaa',strokeWidth:0.8},{type:'line',x1:-2.8,y1:28,x2:2.8,y2:28,stroke:'#888',strokeWidth:1},
      {type:'circle',cx:20,cy:28,r:5.5,fill:'#bbb',stroke:'none'},{type:'circle',cx:20,cy:28,r:5,fill:'url(#gScrew)',stroke:'#aaa',strokeWidth:0.8},{type:'line',x1:17.2,y1:28,x2:22.8,y2:28,stroke:'#888',strokeWidth:1},
      {type:'rect',x:-34,y:-18,width:68,height:9,fill:'#8bc34a',stroke:'none'},
      {type:'rect',x:-34,y:-18,width:68,height:4,fill:'#fff',stroke:'none',opacity:0.3},
      {type:'text',x:0,y:-13,text:'legrand',fontSize:5,fill:'#fff',fontWeight:'bold'},
      {type:'rect',x:-31,y:-8,width:62,height:26,rx:4,fill:'#212121',stroke:'#000',strokeWidth:1},
      {type:'rect',x:-29,y:-7,width:58,height:11,rx:3,fill:'#8bc34a',stroke:'none',opacity:0.9},
      {type:'rect',x:-29,y:-7,width:58,height:5,rx:2,fill:'#fff',stroke:'none',opacity:0.3},
      {type:'text',x:0,y:-2,text:'I',fontSize:9,fill:'#fff',fontWeight:'bold'},
      {type:'text',x:0,y:11,text:'O',fontSize:8,fill:'#555'},
      {type:'rect',x:-30,y:18,width:60,height:8,rx:1.5,fill:'#212121',stroke:'none'},
      {type:'text',x:0,y:22,text:'DX³  3P',fontSize:5.5,fill:'#8bc34a',fontWeight:'bold'},
    ]},
